...
pstmt = conn.prepareStatement("select SUM(Total_fees) from treatment  where did=? and Start_date between ? and ?");
...
rs = pstmt.executeQuery();
	...
	PreparedStatement ps=conn.prepareStatement("select * from treatment where did=? and Start_date between ? and ?");
	ps.setString(1, did);
...
<header id="header" id="home">
		...
		<section class="open-hour-area">
			...
			<form action="totalbuisness.jsp" method="get">
			...
			<div class="col-lg-12 d-flex flex-column mt-20"> 
			  ...
			  <div class="col-lg-12 d-flex flex-column mt-20">
			  <button class="genric-btn primary mt-20 text-uppercase ">Get Total Fees</button>
			  </div>
			  </form>
			  <div class="col-lg-12 d-flex flex-column mt-20">
			  <h2>
			  ...
			  <div class="progress-table-wrap mt-70">
							<div class="progress-table" style="margin-left:50px;width:90%">
								<div class="table-head">
									...
									<div class="visit">Total Fees</div>
...
<div class="visit"><%=rs1.getString("Total_fees")%></div>
