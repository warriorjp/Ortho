...
<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Ortho-Remaining Business</title>
...
String did = (String)s11.getAttribute("did");
...
pstmt2 = conn.prepareStatement("select SUM(Total_fees) from treatment where did=? and Start_date between ? and ?");
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				         <!--  <h2 style="color:#fff;"> Welcome Doctor </h2> -->
				          ...
				          <li><a href="totalbusiness.jsp">Total Business</a></li>
			...
			<section class="open-hour-area">
				<div class="container">
					<div class="row justify-content-center open-hour-wrap">
						...
						<form action="remainingfees.jsp" method="get">
						<div class="col-lg-12 d-flex flex-column">  
			  ...
			  <div class="col-lg-12 d-flex flex-column mt-20">
			  <button class="genric-btn primary mt-20 text-uppercase ">Check Fees</button>
			  </div>
			  </form>
			  </div>
						<div class="col-lg-12 d-flex flex-column mt-20">
					  ...
					  <div class="progress-table-wrap mt-70">
							<div class="progress-table" style="margin-left:50px;width:90%">
								<div class="table-head">
									...
									<div class="visit">Remaining Fees</div>
