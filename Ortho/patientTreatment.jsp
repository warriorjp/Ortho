...
rs1 = ps.executeQuery("select * from patient where Pid = "+pid);
...
while(rs1.next()){				
	...
	session7.setAttribute("pid", rs1.getString(1));
...
<section class="open-hour-area">
				<div class="container">
					<div class="row justify-content-center open-hour-wrap">
						<div class="col-lg-6 no-padding appoinment-right">
		                    ...
		                    <form class="appoinment-form" id="myForm" action="treatmentreg" method="post"> 

		                        <div class="row">
								<div class="col-lg-12 d-flex flex-column">
		                                <input name="Patient_Id" value="<%=rs1.getString(1)%>"  class="form-control mt-20" readonly>
		                            </div>
									...
									<div class="col-lg-12 d-flex flex-column">
									<div class="mt-20">Start Date:</div>
									<input type="date" name="startdate" class="form-control mt-10" >
								
									</div>	
										
								    <!-- <div class="col-lg-12 d-flex flex-column">
									<div class="mt-20">Medicine issued on:</div>
 ...
 -->									
									<div class="col-lg-12 d-flex flex-column">
									<div class="mt-20">
										<textarea class="single-textarea form-control" name="treatment" style="border:solid 1px #D2D1D5" placeholder="Treatment" onfocus="this.placeholder = ''" onblur="this.placeholder = ''"  ></textarea>
									</div>
									</div>
									...
									<div class="col-lg-12 d-flex flex-column">
							        <input name="totalfees" placeholder="Total Amount" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Total Amount'" class="form-control mt-20"   type="text">
		                        	</div>
		                        	...
		                        	<div class="col-lg-12 d-flex flex-column">
							        <input name="ra"  placeholder="Remaining Amount" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Remaining Amount'" class="form-control mt-20"   type="text">
		                        	</div> 
		                        	 -->						
									<div class="col-lg-12 d-flex flex-column">
