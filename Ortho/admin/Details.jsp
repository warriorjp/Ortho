...
rs = ps.executeQuery("select * from docregistration where did = "+did);

PreparedStatement ps2= connection.prepareStatement("select COUNT(Pid) from patient where Did="+did);
ResultSet rs2=ps2.executeQuery();
if(rs2.next())
{
	TotalPatients = rs2.getString(1);
}

PreparedStatement ps3= connection.prepareStatement("select COUNT(Treatment) from treatment where Did="+did);
ResultSet rs3=ps3.executeQuery();
if(rs3.next())
{
	treatments = rs3.getString(1);
}

PreparedStatement ps4= connection.prepareStatement("select SUM(Total_fees) from treatment where Did="+did);
ResultSet rs4=ps4.executeQuery();
if(rs4.next())
{
	Buisness = rs4.getString(1);
}
