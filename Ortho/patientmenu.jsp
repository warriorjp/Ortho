				...
				<div class="container">
					<div class="row justify-content-center open-hour-wrap">
						...
						<div class="col-lg-6 d-flex flex-column mt-20 pl-90">
								...
								<img src="./img/patientadd.png" >
								<h4 style="margin-left:30px">Add Patient</h4>
								</a>
						...
						<div class="col-lg-6 d-flex flex-column mt-20">
								...
								<img src="./img/patientlist.png" class="pt-10 pl-10">
								<h4 style="margin-left:30px">Patients List</h4>
								</a>
