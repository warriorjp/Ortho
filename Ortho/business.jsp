...
String did=(String)session5.getAttribute("did");

System.out.println("tu pan ghe."+did);

String Email = (String)session5.getAttribute("Name");
ResultSet rs =null;
...
PreparedStatement ps=connection.prepareStatement("select * from docregistration where Email=?");
				...
				<div class="container">
					<div class="row justify-content-center open-hour-wrap">
						...
						<div class="col-lg-4 d-flex flex-column mt-20">
                                ...
                                <a href="totalbuisness.jsp">
								<img src="./img/totalbuis.png" style="margin-left:5px;">
								<h4 style="margin-left:10px">  &nbsp; &nbsp; Total &nbsp; &nbsp;&nbsp;
								Buisness</h4>
								</a>
						...
						<div class="col-lg-4 d-flex flex-column mt-20">
                                ...
                                <a href="remainingfees.jsp">
								<img src="./img/totalbuis.png" style="margin-left:5px;">
								<h4 style="margin-left:5px">Remaining 
								Buisness</h4>
								</a>
